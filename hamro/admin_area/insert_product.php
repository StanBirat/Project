...
if(isset($_POST['insert_product'])){
   ...
   $temp_image2 = $_FILES['product_image2']['tmp_name'];
    ...
    or $product_brands=='' or $product_brands=='' or $product_image1=='' or $product_image2=='' or $product_image3==''){
       ...
       move_uploaded_file($temp_image3,"./product_images/$product_image3");
        //inserting data into database
         ...
         values('$product_title','$description','$product_keywords','$product_category','$product_brands','$product_image1',
         '$product_image2','$product_image3','$product_price',NOW(),'$product_status')";

        $result_querry=mysqli_query($con, $insert_product);
        if($result_querry){
...
<!--enctype is used to upload images-->
<!--title-->
...
<div class="form-outline mb-4 w-50 m-auto">
   ...
   btn-light mb-3 px-3" value="Insert Product">
</div>
